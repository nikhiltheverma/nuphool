(function() {
    ...
    function m(b) {
        ...
        0 < a ? (c.smFadeTo(200, 1), e.innerText = a ? a : "") : (e.innerText = a ? a : 0, c.smFadeTo(200, 0));
        F()
    }
    ...
    function y() {
        ...
        switch (v) {
            case 0:
                ...
                break;
            case 1:
                d.style.left = "initial", d.style.right = b + "px"
        }
    }
        ...
        if (window.paypal) n || (n = setInterval(function() {
            ...
            if ((a = b.parentElement.querySelector(".dummy-template-paypal")) && a.remove(), !document.querySelector("#cash-on-delivery")) {
                ...
                h.addEventListener("click", function(a) {
                    ...
                    minicartPaypal.minicart.cart && (minicartPaypal.minicart.cart.destroy(), m());
                    setTimeout(function() {
    ...
    function G(b, a) {
        ...
        c.onload = function() {
            ...
            if (200 > c.status || 400 <= c.status) return a(Error(b.message));
            a(null, b)
        };
        c.onerror = function() {
        ...
        if (!C && document.body) {
            ...
            document.addEventListener("click", function(a) {
                ...
                if (b && (I.test(b) || J.test(b))) {
                    ...
                    if ("_cart" === g) a.stopPropagation(), a.preventDefault(), w = !0, a = E(b.substring(b.indexOf("?") + 1)), g = {
                        amount: a.amount,
                        bn: a.bn,
                        business: a.business,
                    ...
                    }, a.nopayment_whatsapp && (g.nopayment_whatsapp = a.nopayment_whatsapp), a.nopayment_email && (g.nopayment_email = a.nopayment_email), !1 !== minicartPaypal.minicart.cart.add(g) && d && (d.smFadeTo(200, 1), m(!0)), w = !1;
                    else if ("_xclick" === g) {
                        var k = function() {
                            if (!l)
                                if (window.paypal) l = setInterval(function() {
                                    r.innerHTML = "";
                        ...
                        g.addEventListener("click", function(a) {
                            1 >= parseInt(f.quantity) || (f.quantity = parseInt(f.quantity) - 1, t.value = f.quantity, x.innerText = parseFloat(t.value * q).toFixed(2) + " " + p, k())
                        });
                        v.addEventListener("click", function(a) {
                            f.quantity =
                                parseInt(f.quantity) + 1;
                            t.value = f.quantity;
    ...
    function u(b) {
        for (var a in b) D.hasOwnProperty(a) && (c[a] = b[a]);
        H(); - 1 !== location.href.search(/\?success/) && (minicartPaypal.minicart.cart && (minicartPaypal.minicart.cart.destroy(), m()), b = document.createElement("div"), b.classList.add("modal"), b.innerHTML = '\n\t\t\t\t\t<div id="approve-window" class="modal-dialog display-7" style="display:flex;height:auto;">\n\t\t\t\t\t\t<div class="modal-content" style="height:auto;">\n\t\t\t\t\t\t\t<div class="modal-header" style="border:none;">\n\t\t\t\t\t\t\t\t<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class="modal-body align-center">\n\t\t\t\t\t\t\t\t<h6 class="display-5">Thank you for your order!</h6>\n\t\t\t\t\t\t\t\t<div data-bs-dismiss="modal" class="btn btn-primary">Close</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class="modal-footer" style="border:none;display:block;">\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>',
    ...
    Element.prototype.smFadeTo = function(b, a) {
        ...
        d.style.opacity = a;
        0 === a ? d.addEventListener("transitionend",
            c(), {
                once: !0
            }) : (d.removeEventListener("transitionend", c()), d.style.display = "flex")
    };
    ...
    if ("undefined" === typeof minicartPaypal || "undefined" === typeof minicartPaypal.minicart) return -1;
